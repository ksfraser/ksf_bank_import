...
class HtmlInput extends HtmlEmptyElement
{
	...
	/**
	 * Whether the input is rendered checked (checkbox/radio)
	 * @var bool
	 */
	...
	/**
	 * Set the checked state (checkbox and radio inputs)
	 *
	 * @param bool $checked True to render as checked.
	 * @return self Fluent interface
	 */
	public function setChecked( bool $checked = true ): self
	{
		...
		if ( $checked )
		{
			$this->addAttribute( new HtmlAttribute( 'checked', 'checked' ) );
		}
		return $this;
	}
}
