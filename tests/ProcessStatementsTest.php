...
class ProcessStatementsControllerTest extends TestCase
{
	...
	/* Process Statements runs a bunch of checks against _POST
	 * UnsetTrans
	 * AddCUstomer
	 * AddVendor
	 * ToggleTransaction
	 *
	 * These all call actions on bi_controller
	 */
	require_once( __DIR__ . '/../process_statements.php' );
/*
...
*/
	...
	protected function usePopupWindowsTest()
	{
		global $use_popup_windows, $js;
