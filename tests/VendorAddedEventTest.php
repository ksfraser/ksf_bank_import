...
use Ksfraser\FaBankImport\Events\VendorAddedEvent;
...
class VendorAddedEventTest extends TestCase
{
	private $element;
	private $id;
	private $timestamp;
	...
	protected function setUp(): void
	{
		...
		$this->element = new VendorAddedEvent( $this->id );
	...
	public function testConstructor():void
	{
		...
		$this->assertEquals( $error["errstr"], "Created Supplier ID $this->id" );
            	$this->assertEquals( $error["errno"], E_USER_NOTICE ); 
            }
	}
